  ...
  <body>
    <div class="contact-section">
      <div class="inner-width">
        ...
        <form method="POST" action="ajouter-eleve.php">
        ...
        <div class="w1">
        <a href="recherche-eleve.php" class="bt1">recherche</a>
        <h5 style="margin-top: 20px;">Recherche par nom et<br> date de naisssance si l'eleve exist deja</h5>
    </div>
      </div>
    </div>
  </body>
